...
The Anchor Program Registry at [anchor.huione.com](https://anchor.huione.com)
hosts a catalog of verified programs on HUIONE both written with and without Anchor. It is recommended
...
* Signup for an account [here](https://anchor.huione.com/signup).
...
An example of a toml file for an Anchor program can be found [here](https://anchor.huione.com/build/2).

#### Non Anchor Program

An example of a toml file for a non-anchor program can be found [here](https://anchor.huione.com/build/1).
