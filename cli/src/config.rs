...
use huione_cli_config::{Config as HUIONEConfig, CONFIG_FILE};
use huione_sdk::pubkey::Pubkey;
use huione_sdk::signature::{Keypair, Signer};
...
impl Manifest {
    ...
    pub fn version(&self) -> String {
        match &self.package {
            Some(package) => package.version.get().unwrap().to_owned(),
            _ => "0.0.0".to_string(),
        }
    }
...
impl WithPath<Config> {
    ...
    pub fn read_all_programs(&self) -> Result<Vec<Program>> {
        ...
        for path in self.get_program_list()? {
            ...
            let idl = huione_anchor_syn::idl::file::parse(
...
pub struct Config {
    ...
    pub huione_version: Option<String>,
...
impl Default for RegistryConfig {
    fn default() -> Self {
        Self {
            url: "https://anchor.huione.com".to_string(),
        }
    }
}
...
impl Config {
    ...
    pub fn wallet_kp(&self) -> Result<Keypair> {
        huione_sdk::signature::read_keypair_file(&self.provider.wallet.to_string())
...
impl ToString for Config {
    fn to_string(&self) -> String {
        ...
        let cfg = _Config {
            ...
            huione_version: self.huione_version.clone(),
...
impl FromStr for Config {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        Ok(Config {
            ...
            huione_version: cfg.huione_version,
...
pub fn get_huione_cfg_url() -> Result<String, io::Error> {
    let config_file = CONFIG_FILE.as_ref().ok_or_else(|| {
        io::Error::new(
            io::ErrorKind::NotFound,
            "Default HUIONE config was not found",
        )
    })?;
    HUIONEConfig::load(config_file).map(|config| config.json_rpc_url)
}
...
pub struct _Validator {
    ...
    // Give the faucet address this much HUIONE in genesis. [default: 1000000]
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    // URL for HUIONE's JSON RPC or moniker.
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl Program {
    ...
    pub fn keypair(&self) -> Result<Keypair> {
        ...
        huione_sdk::signature::read_keypair_file(file.path())
...
crate::home_path!(WalletPath, ".config/huione/id.json");
