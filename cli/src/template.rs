...
pub fn deploy_js_script_host(cluster_url: &str, script_path: &str) -> String {
    format!(
        r#"
const anchor = require('@xoneorg/huione-anchor');
...
pub fn deploy_ts_script_host(cluster_url: &str, script_path: &str) -> String {
    format!(
        r#"import * as anchor from '@xoneorg/huione-anchor';
...
pub fn lib_rs(name: &str) -> String {
    format!(
        r#"use huione_anchor_lang::prelude::*;
...
pub fn mocha(name: &str) -> String {
    format!(
        r#"const anchor = require("@xoneorg/huione-anchor");
...
pub fn ts_mocha(name: &str) -> String {
    format!(
        r#"import * as anchor from "@xoneorg/huione-anchor";
import {{ Program }} from "@xoneorg/huione-anchor";
