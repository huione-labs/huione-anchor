...
///     fn is_authorized(ctx: Context<T>, current: u64, new: u64) -> huione_anchor_lang::Result<()>;
/// }
///
/// #[program]
/// pub mod counter {
...
/// with the SPL's [Shared Memory Program](https://github.com/huione-labs/huione-program-library/tree/master/shared-memory).
...
pub fn interface(
    ...
    let methods: Vec<proc_macro2::TokenStream> = item_trait
        ...
        .map(|method: &syn::TraitItemMethod| {
            ...
            let sighash_arr = huione_anchor_syn::codegen::program::common::sighash(&trait_name, &method_name.to_string());
            let sighash_tts: proc_macro2::TokenStream =
                format!("{:?}", sighash_arr).parse().unwrap();
            quote! {
                pub fn #method_name<'a,'b, 'c, 'info, T: huione_anchor_lang::Accounts<'info> + huione_anchor_lang::ToAccountMetas + huione_anchor_lang::ToAccountInfos<'info>>(
                    ctx: huione_anchor_lang::context::CpiContext<'a, 'b, 'c, 'info, T>,
                    #(#args),*
                    ...
                    let ix = {
                        ...
                        let mut ix_data = huione_anchor_lang::AnchorSerialize::try_to_vec(&ix)
