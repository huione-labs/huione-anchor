...
/// An attribute for a data structure representing a HUIONE account.
///
    ...
    let owner_impl = {
        if namespace.is_empty() {
            quote! {
                ...
                impl #impl_gen huione_anchor_lang::Owner for #account_name #type_gen #where_clause {
                    fn owner() -> Pubkey {
                        crate::ID
                    }
                }
    ...
    proc_macro::TokenStream::from({
        if is_zero_copy {
            quote! {
                ...
                #[automatically_derived]
                unsafe impl #impl_gen huione_anchor_lang::__private::bytemuck::Pod for #account_name #type_gen #where_clause {}
                #[automatically_derived]
                unsafe impl #impl_gen huione_anchor_lang::__private::bytemuck::Zeroable for #account_name #type_gen #where_clause {}

                #[automatically_derived]
                impl #impl_gen huione_anchor_lang::ZeroCopy for #account_name #type_gen #where_clause {}

                #[automatically_derived]
                impl #impl_gen huione_anchor_lang::Discriminator for #account_name #type_gen #where_clause {
                ...
                #[automatically_derived]
                impl #impl_gen huione_anchor_lang::AccountDeserialize for #account_name #type_gen #where_clause {
                    fn try_deserialize(buf: &mut &[u8]) -> huione_anchor_lang::Result<Self> {
                        if buf.len() < #discriminator.len() {
                            return Err(huione_anchor_lang::error::ErrorCode::AccountDiscriminatorNotFound.into());
                        }
                        let given_disc = &buf[..8];
                        if &#discriminator != given_disc {
                            return Err(huione_anchor_lang::error::ErrorCode::AccountDiscriminatorMismatch.into());
                        }
                    ...
                    fn try_deserialize_unchecked(buf: &mut &[u8]) -> huione_anchor_lang::Result<Self> {
                        ...
                        let account = huione_anchor_lang::__private::bytemuck::from_bytes(data);
            ...
            quote! {
                ...
                #[automatically_derived]
                impl #impl_gen huione_anchor_lang::AccountSerialize for #account_name #type_gen #where_clause {
                ...
                impl #impl_gen huione_anchor_lang::AccountDeserialize for #account_name #type_gen #where_clause {
                    ...
                    fn try_deserialize_unchecked(buf: &mut &[u8]) -> huione_anchor_lang::Result<Self> {
                        ...
                        AnchorDeserialize::deserialize(&mut data)
                            .map_err(|_| huione_anchor_lang::error::ErrorCode::AccountDidNotDeserialize.into())
                    }
                }
    ...
    let methods: Vec<proc_macro2::TokenStream> = fields
        ...
        .filter_map(|field: &syn::Field| {
            field
                .attrs
                .iter()
                .find(|attr| huione_anchor_syn::parser::tts_to_string(&attr.path) == "accessor")
                .map(|attr| {
                    ...
                    quote! {
                        pub fn #get_field(&self) -> #accessor_ty {
                            huione_anchor_lang::__private::ZeroCopyAccessor::get(&self.#field_name)
                        }
                        pub fn #set_field(&mut self, input: &#accessor_ty) {
                            self.#field_name = huione_anchor_lang::__private::ZeroCopyAccessor::set(input);
                        }
                    }
                })
        })
...
pub fn zero_copy(
    ...
    let attr = account_strct
        .attrs
        .iter()
        .find(|attr| huione_anchor_syn::parser::tts_to_string(&attr.path) == "repr");
    ...
    proc_macro::TokenStream::from(quote! {
        #[derive(huione_anchor_lang::__private::ZeroCopyAccessor, Copy, Clone)]
        #repr
        #account_strct
    })
}
