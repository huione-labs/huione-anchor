...
pub fn generate(error: Error) -> proc_macro2::TokenStream {
    ...
    let offset = match error.args {
        None => quote! { huione_anchor_lang::error::ERROR_CODE_OFFSET},
        Some(args) => {
    ...
    quote! {
        ...
        impl From<#enum_name> for huione_anchor_lang::error::Error {
            fn from(error_code: #enum_name) -> huione_anchor_lang::error::Error {
