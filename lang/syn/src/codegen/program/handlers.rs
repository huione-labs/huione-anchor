...
// Generate non-inlined wrappers for each instruction handler, since HUIONE's
...
pub fn generate(program: &Program) -> proc_macro2::TokenStream {
    ...
    let non_inlined_idl: proc_macro2::TokenStream = {
        quote! {
            ...
            pub fn __idl_dispatch(program_id: &Pubkey, accounts: &[AccountInfo], idl_ix_data: &[u8]) -> huione_anchor_lang::Result<()> {
                let mut accounts = accounts;
                let mut data: &[u8] = idl_ix_data;

                let ix = huione_anchor_lang::idl::IdlInstruction::deserialize(&mut data)
                    .map_err(|_| huione_anchor_lang::error::ErrorCode::InstructionDidNotDeserialize)?;

                match ix {
                    huione_anchor_lang::idl::IdlInstruction::Create { data_len } => {
                        let mut bumps = std::collections::BTreeMap::new();
                        let mut accounts =
                            huione_anchor_lang::idl::IdlCreateAccounts::try_accounts(program_id, &mut accounts, &[], &mut bumps)?;
                        __idl_create_account(program_id, &mut accounts, data_len)?;
                        accounts.exit(program_id)?;
                    },
                    huione_anchor_lang::idl::IdlInstruction::CreateBuffer => {
                        let mut bumps = std::collections::BTreeMap::new();
                        let mut accounts =
                            huione_anchor_lang::idl::IdlCreateBuffer::try_accounts(program_id, &mut accounts, &[], &mut bumps)?;
                        __idl_create_buffer(program_id, &mut accounts)?;
                        accounts.exit(program_id)?;
                    },
                    huione_anchor_lang::idl::IdlInstruction::Write { data } => {
                        let mut bumps = std::collections::BTreeMap::new();
                        let mut accounts =
                            huione_anchor_lang::idl::IdlAccounts::try_accounts(program_id, &mut accounts, &[], &mut bumps)?;
                        __idl_write(program_id, &mut accounts, data)?;
                        accounts.exit(program_id)?;
                    },
                    huione_anchor_lang::idl::IdlInstruction::SetAuthority { new_authority } => {
                        let mut bumps = std::collections::BTreeMap::new();
                        let mut accounts =
                            huione_anchor_lang::idl::IdlAccounts::try_accounts(program_id, &mut accounts, &[], &mut bumps)?;
                    ...
                    huione_anchor_lang::idl::IdlInstruction::SetBuffer => {
                        let mut bumps = std::collections::BTreeMap::new();
                        let mut accounts =
                            huione_anchor_lang::idl::IdlSetBuffer::try_accounts(program_id, &mut accounts, &[], &mut bumps)?;
            ...
            #[cfg(feature = "no-idl")]
            pub fn __idl_dispatch(program_id: &Pubkey, accounts: &[AccountInfo], idl_ix_data: &[u8]) -> huione_anchor_lang::Result<()> {
                Err(huione_anchor_lang::error::ErrorCode::IdlInstructionStub.into())
            }
            ...
            pub fn __idl_create_account(
                program_id: &Pubkey,
                accounts: &mut huione_anchor_lang::idl::IdlCreateAccounts,
                data_len: u64,
            ) -> huione_anchor_lang::Result<()> {
                #[cfg(not(feature = "no-log-ix-name"))]
                huione_anchor_lang::prelude::msg!("Instruction: IdlCreateAccount");

                if program_id != accounts.program.key {
                    return Err(huione_anchor_lang::error::ErrorCode::IdlInstructionInvalidProgram.into());
                }
                // Create the IDL's account.
                let from = accounts.from.key;
                let (base, nonce) = Pubkey::find_program_address(&[], program_id);
                let seed = huione_anchor_lang::idl::IdlAccount::seed();
                ...
                let seeds = &[&[nonce][..]];
                let ix = huione_anchor_lang::huione_program::system_instruction::create_account_with_seed(
                    from,
                    &to,
                    &base,
                    seed,
                ...
                huione_anchor_lang::huione_program::program::invoke_signed(
                    &ix,
                    &[
                        accounts.from.clone(),
                        accounts.to.clone(),
                ...
                let mut idl_account = {
                    ...
                    huione_anchor_lang::idl::IdlAccount::try_deserialize_unchecked(
            ...
            pub fn __idl_create_buffer(
                program_id: &Pubkey,
                accounts: &mut huione_anchor_lang::idl::IdlCreateBuffer,
            ) -> huione_anchor_lang::Result<()> {
                #[cfg(not(feature = "no-log-ix-name"))]
                huione_anchor_lang::prelude::msg!("Instruction: IdlCreateBuffer");
            ...
            pub fn __idl_write(
                program_id: &Pubkey,
                accounts: &mut huione_anchor_lang::idl::IdlAccounts,
                idl_data: Vec<u8>,
            ) -> huione_anchor_lang::Result<()> {
                #[cfg(not(feature = "no-log-ix-name"))]
                huione_anchor_lang::prelude::msg!("Instruction: IdlWrite");
            ...
            pub fn __idl_set_authority(
                ...
                #[cfg(not(feature = "no-log-ix-name"))]
                huione_anchor_lang::prelude::msg!("Instruction: IdlSetAuthority");
            ...
            pub fn __idl_set_buffer(
                program_id: &Pubkey,
                accounts: &mut huione_anchor_lang::idl::IdlSetBuffer,
            ) -> huione_anchor_lang::Result<()> {
                #[cfg(not(feature = "no-log-ix-name"))]
                huione_anchor_lang::prelude::msg!("Instruction: IdlSetBuffer");
            ...
            Some((_ctor, anchor_ident)) => {
                ...
                if state.is_zero_copy {
                    quote! {
                        ...
                        // invocations.
                        #[inline(never)]
                        pub fn __ctor(program_id: &Pubkey, accounts: &[AccountInfo], ix_data: &[u8]) -> huione_anchor_lang::Result<()> {
                            #[cfg(not(feature = "no-log-ix-name"))]
                            huione_anchor_lang::prelude::msg!(#ix_name_log);
                            ...
                            let loader: huione_anchor_lang::accounts::loader::Loader<#mod_name::#name> = huione_anchor_lang::accounts::loader::Loader::try_from_unchecked(program_id, &ctor_accounts.to)?;
                            ...
                            // so that we can subsequently run the exit routine.
                            {
                                ...
                                instance.new(
                                    huione_anchor_lang::context::Context::new(
                                        program_id,
                    ...
                    quote! {
                        ...
                        pub fn __ctor(program_id: &Pubkey, accounts: &[AccountInfo], ix_data: &[u8]) -> huione_anchor_lang::Result<()> {
                            ...
                            let from = ctor_accounts.from.key;
                            let (base, nonce) = Pubkey::find_program_address(&[], ctor_accounts.program.key);
                            let seed = huione_anchor_lang::accounts::state::ProgramState::<#name>::seed();
                            let owner = ctor_accounts.program.key;
                            let to = Pubkey::create_with_seed(&base, seed, owner).unwrap();
                            let space = huione_anchor_lang::__private::AccountSize::size(&instance)?;
                            let rent = Rent::get()?;
                            let lamports = rent.minimum_balance(std::convert::TryInto::try_into(space).unwrap());
                            let seeds = &[&[nonce][..]];
                            let ix = huione_anchor_lang::huione_program::system_instruction::create_account_with_seed(
                        ...
                        if state.is_zero_copy {
                            quote! {
                                ...
                                pub fn #private_ix_method_name(
                                    ...
                                    if remaining_accounts.is_empty() {
                                        return Err(huione_anchor_lang::error::ErrorCode::AccountNotEnoughKeys.into());
                                    }
                                    let loader: huione_anchor_lang::accounts::loader::Loader<#mod_name::#name> = huione_anchor_lang::accounts::loader::Loader::try_accounts(program_id, &mut remaining_accounts, &[], &mut __bumps)?;
                            ...
                            quote! {
                                ...
                                pub fn #private_ix_method_name(
                                    ...
                                    let mut state: huione_anchor_lang::accounts::state::ProgramState<#state_ty> = huione_anchor_lang::accounts::state::ProgramState::try_accounts(
                                        program_id,
                                        &mut remaining_accounts,
                                        &[],
                                        &mut __bumps,
                        ...
                        iface
                            ...
                            .map(|ix| {
                                ...
                                let args_struct = {
                                    if ix.args.is_empty() {
                                        quote! {
                                            #[derive(huione_anchor_lang::AnchorSerialize, huione_anchor_lang::AnchorDeserialize)]
                                            struct Args;
                                        }
                                    } else {
                                        quote! {
    ...
    let non_inlined_handlers: Vec<proc_macro2::TokenStream> = program
        ...
        .map(|ix| {
            ...
            let maybe_set_return_data = match ret_type.to_string().as_str() {
                "()" => quote! {},
                _ => quote! {
                    huione_anchor_lang::huione_program::program::set_return_data(&result.try_to_vec().unwrap());
                },
            };
            quote! {
                #[inline(never)]
