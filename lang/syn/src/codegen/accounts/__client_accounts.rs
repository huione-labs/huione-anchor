...
pub fn generate(accs: &AccountsStruct) -> proc_macro2::TokenStream {
    ...
    let account_struct_fields: Vec<proc_macro2::TokenStream> = accs
        ...
        .map(|f: &AccountField| match f {
            ...
            AccountField::Field(f) => {
                ...
                quote! {
                    #docs
                    pub #name: huione_anchor_lang::huione_program::pubkey::Pubkey
                }
            }
        })
        .collect();
    ...
    quote! {
        ...
        pub(crate) mod #account_mod_name {
            use super::*;
            use huione_anchor_lang::prelude::borsh;
            #(#re_exports)*

            #struct_doc
            #[derive(huione_anchor_lang::AnchorSerialize)]
            pub struct #name {
                #(#account_struct_fields),*
            }

            #[automatically_derived]
            impl huione_anchor_lang::ToAccountMetas for #name {
