    ...
    pub fn container_ty(&self) -> proc_macro2::TokenStream {
        match &self.ty {
            Ty::ProgramAccount(_) => quote! {
                huione_anchor_lang::accounts::program_account::ProgramAccount
            },
            Ty::Account(_) => quote! {
                huione_anchor_lang::accounts::account::Account
            },
            Ty::AccountLoader(_) => quote! {
                huione_anchor_lang::accounts::account_loader::AccountLoader
            },
            Ty::Loader(_) => quote! {
                huione_anchor_lang::accounts::loader::Loader
            },
            Ty::CpiAccount(_) => quote! {
                huione_anchor_lang::accounts::cpi_account::CpiAccount
            },
            Ty::Sysvar(_) => quote! { huione_anchor_lang::accounts::sysvar::Sysvar },
            Ty::CpiState(_) => quote! { huione_anchor_lang::accounts::cpi_state::CpiState },
            Ty::ProgramState(_) => quote! { huione_anchor_lang::accounts::state::ProgramState },
            Ty::Program(_) => quote! { huione_anchor_lang::accounts::program::Program },
            Ty::AccountInfo => quote! {},
            Ty::UncheckedAccount => quote! {},
            Ty::Signer => quote! {},
            Ty::SystemAccount => quote! {},
...
pub struct ConstraintGroup {
    ...
    mint_meta: Option<ConstraintTokenMintMetaGroup>,
}
...
pub enum Constraint {
    ...
    MintMetaGroupConstraint(ConstraintTokenMintMetaGroup),
}
...
pub enum ConstraintToken {
    ...
    MetaAuth(Context<ConstraintTokenAuthority>),
    MetaMint(Context<ConstraintMetaMint>),
    MetaSymbol(Context<ConstraintMetaSymbol>),
    MetaName(Context<ConstraintMetaName>),
    MetaIcon(Context<ConstraintMetaIcon>),
}
...
#[derive(Debug, Clone)]
pub struct ConstraintMetaMint {
    meta_mint: Expr,
}


#[derive(Debug, Clone)]
pub struct ConstraintMetaSymbol {
    meta_symbol: Expr,
}


#[derive(Debug, Clone)]
pub struct ConstraintMetaName {
    meta_name: Expr,
}

#[derive(Debug, Clone)]
pub struct ConstraintMetaIcon {
    meta_icon: Expr,
}
...
#[derive(Debug, Clone)]
pub struct ConstraintTokenMintMetaGroup {
    pub meta_authority: Expr,
    pub meta_mint: Expr,
    pub meta_symbol: Expr,
    pub meta_name: Expr,
    pub meta_icon: Expr,
}
