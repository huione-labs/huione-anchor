...
/// ```ignore
/// ...
/// pub fn initialize(ctx: Context<Create>, bump: u8, authority: Pubkey, data: u64) -> huione_anchor_lang::Result<()> {
///     ...
///     Ok(())
/// }
/// ...
...
pub fn derive_anchor_deserialize(item: TokenStream) -> TokenStream {
    parse_macro_input!(item as huione_anchor_syn::AccountsStruct)
        .to_token_stream()
        .into()
}
