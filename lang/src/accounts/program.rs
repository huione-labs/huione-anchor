...
use huione_program::bpf_loader_upgradeable::{self, UpgradeableLoaderState};
...
/// if the program is owned by the [`BPFUpgradeableLoader`](https://docs.rs/huione-program/latest/huione_program/bpf_loader_upgradeable/index.html)
/// which will contain the `programdata_address` property of the `Program` variant of the [`UpgradeableLoaderState`](https://docs.rs/huione-program/latest/huione_program/bpf_loader_upgradeable/enum.UpgradeableLoaderState.html) enum.
///
/// # Table of Contents
...
///
/// Between the [`huione_anchor_lang`](https://docs.rs/anchor-lang/latest/huione_anchor_lang) and [`anchor_spl`](https://docs.rs/anchor_spl/latest/anchor_spl) crates,
/// the following `Program` types are provided out of the box:
///
/// - [`System`](https://docs.rs/anchor-lang/latest/huione_anchor_lang/struct.System.html)
