...
use huione_anchor_lang::{context::CpiContext, Accounts, Result, ToAccountInfos};
...
huione_anchor_lang::huione_program::declare_id!("9xQeWvG816bUx9EPjHmaT23yvVM2ZWbrrpZb9PusVFin");

#[cfg(feature = "devnet")]
huione_anchor_lang::huione_program::declare_id!("DESVgJVGajEgKGXhb6XmqDHGz3VjdgP7rEVESBgxmroY");
...
impl huione_anchor_lang::Id for Dex {
    fn id() -> Pubkey {
        ID
    }
}
