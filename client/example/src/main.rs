use huione_anchor_client::huione_sdk::commitment_config::CommitmentConfig;
use huione_anchor_client::huione_sdk::pubkey::Pubkey;
use huione_anchor_client::huione_sdk::signature::read_keypair_file;
use huione_anchor_client::huione_sdk::signature::{Keypair, Signer};
use huione_anchor_client::huione_sdk::system_instruction;
use huione_anchor_client::{Client, Cluster, EventContext};
use anyhow::Result;
use huione_sdk::system_program;
...
fn main() -> Result<()> {
    ...
    let payer = read_keypair_file(&*shellexpand::tilde("~/.config/huione/id.json"))
...
fn events(client: &Client, pid: Pubkey) -> Result<()> {
    ...
    // TODO: remove once https://github.com/huione-labs/huione/issues/16102
