...
import {
  ...
  Context,
  ContextPRC,
  SimulatedTransactionResponsePRCToSimulatedTransactionResponse,
} from "@xoneorg/web3.js";
...
// copy from @xoneorg/web3.js that has a commitment param
export async function simulateTransaction(
  ...
  // return res.result;
  const ctx = new Context(res.result.context);
  const va = SimulatedTransactionResponsePRCToSimulatedTransactionResponse(res.result.value);
  return {context:ctx,value:va};
}

// copy from @xoneorg/web3.js
